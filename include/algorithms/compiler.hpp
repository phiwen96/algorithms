...
// */
//
//template <template <typename> typename scanner, typename token>
//struct compiler
//{
//    array <int> code;
//    array <int> consts;
...
//     */
//    auto consume (typename token::type t, const char* msg) -> void;
...
////    };
//    
//    static auto get_rule(typename token::type type) -> parse_rule*
//    {
////      return &rules[type];
//    }
//    
...
//
//template <template <typename> typename scanner, typename token>
//compiler <scanner, token>::compiler (char const* source) : sc {source}
//{
//    advance ();
//    expression ();
...
//
//template <template <typename> typename scanner, typename token>
//compiler<scanner, token>::operator bool () const
//{
//    return not prs.had_error;
//}
//
//template <template <typename> typename scanner, typename token>
//auto compiler<scanner, token>::advance () -> void
//{
...
//
//template <template <typename> typename scanner, typename token>
//auto compiler<scanner, token>::consume (typename token::type t, const char* msg) -> void
//{
//  if (prs.current.t == t)
//  {
//    advance ();
...
//
//template <template <typename> typename scanner, typename token>
//auto compiler<scanner, token>::expression () -> void
//{
//    parse_precedence (PREC_ASSIGNMENT);
//}
//
//template <template <typename> typename scanner, typename token>
//auto compiler<scanner, token>::unary() -> void
//{
//    typename token::type operatorType = prs.previous.t;
//
//  // Compile the operand.
//  expression ();
//    
...
//
//template <template <typename> typename scanner, typename token>
//auto compiler<scanner, token>::grouping() -> void
//{
//  expression ();
...
//
//template <template <typename> typename scanner, typename token>
//auto compiler<scanner, token>::number() -> void
//{
...
//
//template <template <typename> typename scanner, typename token>
//auto compiler<scanner, token>::error_at_current(const char* msg) -> void
//{
//    error_at (&prs.current, msg);
//}
//
//template <template <typename> typename scanner, typename token>
//auto compiler<scanner, token>::error(const char* msg) -> void
//{
//    error_at (&prs.previous, msg);
//}
//
//template <template <typename> typename scanner, typename token>
//auto compiler<scanner, token>::error_at (token* tok, const char* msg) -> void
//{
//    if (prs.panic_mode)
//    {
//        return;
...
//
//template <template <typename> typename scanner, typename token>
//auto compiler<scanner, token>::parse_precedence (precedence p) -> void
//{
//    advance();
//    
...
//
//template <template <typename> typename scanner, typename token>
//auto compiler<scanner, token>::binary () -> void
//{
//    typename token::type operatorType = prs.previous.t;
...
//          case token::type::TOKEN_MINUS:         emit_bytes (opcode::OP_SUBTRACT); break;
//          case token::type::TOKEN_STAR:          emit_bytes (opcode::OP_MULTIPLY); break;
//          case token::type::TOKEN_SLASH:         emit_bytes (opcode::OP_DIVIDE); break;
//        default: return; // Unreachable.
//      }
//}
//
//template <template <typename> typename scanner, typename token>
//auto compiler<scanner, token>::emit_constants(int value) -> void
//{
//  emit_bytes (opcode::OP_CONSTANT, make_constant (value));
//}
//
//template <template <typename> typename scanner, typename token>
//auto compiler<scanner, token>::make_constant (int value) -> int
//{
//    consts += value;
...
//
//template <template <typename> typename scanner, typename token>
//auto compiler<scanner, token>::emit_return () -> void
//{
//    emit_bytes (opcode::OP_RETURN);
//}
//
//template <template <typename> typename scanner, typename token>
//auto compiler<scanner, token>::emit_bytes (auto... b) -> void
//{
//    ((code += b), ...);
//}
